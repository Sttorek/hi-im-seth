        ...
        <div className="firstProjectBackground">
          <div className="projCont">
            <div className="Titles">
              ...
              <p className="projectDesc">An app designed for developers to practice their skills, tract their progress and learn new skills as well.</p>
            </div>
        ...
        <div className="secondProjectBackground">
          <div className="projCont">
            <div className="Titles">
              ...
              <p className="projectDesc">Designed to make it easier a company or individual to keep track of their properties, tenants, and more.</p>
            </div>
        ...
        <div className="thirdProjectBackground">
          <div className="projCont">
            <div className="Titles">
             ...
             <p className="projectDesc">Thinking of adopting a pet? You can now search around your area for shelters through third party APIs to <br/> find the right animal for you.</p>
            </div>
        ...
        <div className="fourthProjectBackground">
          <div className="projCont">
            <div className="Titles">
              ...
              <p className="projectDesc">Created so that you may never miss another meeting or get off track. Always be organized and ready for <br/>the day.</p>
            </div>
